...
// - на ракетата могат да се подават boolean команди за активиране на двигатели forward,
//        backward, left, right, както и команда stop, която канселира действието на двигателите;
// - ракетата сe ускорява със сила равна на 40 за forward и backward двигателите, няма
//    ограничение за максимална скорост, има съпротивление;
// - страничните двигатели ротират ракетата с 0.03 радиана за импулс;
...
//   * getSpeed([x, y]) - калкулира скорост от вектор.
